...
public class ConstellationRepositoryOld {
	...
	public List<Constellation> findAllConstellations() {
		return em.createQuery("SELECT c from Constellation c order by c.code").getResultList();
	}

	public Constellation findConstellationByCode(String code) {
		Query query = em
				.createQuery("Select c from Constellation c where c.code = :code");
	...
	public List<Constellation> findAllConstellationsByConstellationNames(List<String> codes) {
		Query query = em
				.createQuery("Select c from Constellation c where c.code in :codes Order By c.code");
