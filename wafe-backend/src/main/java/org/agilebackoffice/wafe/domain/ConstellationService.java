...
public class ConstellationService{
	...
	/* (non-Javadoc)
	 * @see org.agilebackoffice.wafe.domain.IConstellation#findAllConstellations()
	 */
	...
	/* (non-Javadoc)
	 * @see org.agilebackoffice.wafe.domain.IConstellation#findConstellationByCode(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.agilebackoffice.wafe.domain.IConstellation#findAllConstellationByCodeOrName(java.lang.String)
	 */
	public List<Constellation> findAllConstellationByCodeOrName(String search) {
		return constellationRepository.findAllConstellationByCodeOrName(search);
	}
	
	/* (non-Javadoc)
	 * @see org.agilebackoffice.wafe.domain.IConstellation#findAllCommentsByConstellation(org.agilebackoffice.wafe.domain.Constellation)
	 */
	...
	/* (non-Javadoc)
	 * @see org.agilebackoffice.wafe.domain.IConstellation#addCommentToConstellation(org.agilebackoffice.wafe.domain.Constellation, org.agilebackoffice.wafe.domain.Comment)
	 */
	...
	/* (non-Javadoc)
	 * @see org.agilebackoffice.wafe.domain.IConstellation#removeCommentFromConstellation(org.agilebackoffice.wafe.domain.Comment)
	 */
